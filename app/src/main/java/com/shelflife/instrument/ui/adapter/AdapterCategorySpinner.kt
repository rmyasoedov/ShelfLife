...
class AdapterCategorySpinner(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        val view: View = convertView ?: LayoutInflater.from(appContext).inflate(R.layout.item_category_viewspinner, parent, false)
    ...
    fun getPositionIdCategory(categoryId: Int): Int{
